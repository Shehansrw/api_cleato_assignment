...
@ComponentScan({ "cleato.assigmnt.api_cleato_assignment.configurations" })
...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "cleato.assigmnt.api_cleato_assignment.model" });
